<template>
  <nuxt-link :to="`/players/${player.name}`" class="flex flex-row sm:flex-col items-center sm:items-start w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 md:mt-4 p-2 sm:p-6 no-underline text-black" activeClass="text-darker-indigo">
