  ...
  <nav class="absolute md:relative lg:flex lg:text-lg bg-grey-light md:bg-transparent pin-l pin-r md:pin-none py-4 px-6 lg:pt-10 lg:pl-12 lg:pr-6 lg:mt-0 overflow-y-auto md:w-1/4 lg:w-1/5 xl:w-1/6 md:border-r z-40 hidden md:block" id="sidebar">
    <ul class="list-reset mb-8 w-full">
      <li class="ml-2 mb-4 flex">
        ...
        <nuxt-link class="hover:cursor-pointer text-white text-indigo-darkest no-underline font-medium mobile-home-trigger" to="/">首頁</nuxt-link>
      </li>
      <li class="ml-2 mb-4">
        <div class="flex" id="sidenav-categories-trigger">
          <img src="/images/iconmonstr-basketball-2.svg" alt="home-icon" class="w-4 h-4 mr-2">
          <div class="hover:cursor-pointer text-white text-indigo-darkest no-underline font-medium w-full relative">
            戰績
        ...
        <ul class="text-grey lg:text-grey-dark list-reset leading-loose mt-2" id="sidenav-categories">
          <li v-for="entry in dateEntryList" class="transition-normal ml-1 border-l border-grey-dark pl-4">
            <nuxt-link class="no-underline text-grey-dark hover:text-indigo-dark hover:cursor-pointer" :to="`/games/${entry}`" activeClass="text-indigo-darker font-medium">{{ entry }}</nuxt-link>
          </li>
        </ul>
      </li>
      <li class="ml-2 mb-4 flex">
        <img src="/images/iconmonstr-friend-3.svg" alt="wishlist-icon" class="w-4 h-4 mr-2">
        <nuxt-link class="hover:cursor-pointer text-white text-indigo-darkest no-underline font-medium mobile-home-trigger" to="/teams" activeClass="text-indigo-dark font-medium">隊伍</nuxt-link>
      </li>
      <li class="ml-2 mb-4 flex">
        <img src="/images/iconmonstr-generation-1.svg" alt="wishlist-icon" class="w-4 h-4 mr-2">
        <nuxt-link class="hover:cursor-pointer text-white text-indigo-darkest no-underline font-medium mobile-home-trigger" to="/players" activeClass="text-indigo-dark font-medium">成員</nuxt-link>
      </li>
