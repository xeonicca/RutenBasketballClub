...
<nuxt-link class="max-w-sm w-full sm:w-1/2 lg:w-1/5 py-6 px-3 block" :to="`/teams/${team.id}`">
  <div class="bg-white shadow-xl rounded-lg overflow-hidden">
    <div class="bg-cover bg-no-repeat bg-center h-56 p-4" :style="`background-image: url(${team.imageUrl})`">
    </div>
    <div class="p-4">
    ...
    <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
      ...
      <div class="flex items-center pt-2">
        <div class="bg-cover bg-center w-10 h-10 rounded-full mr-3" :style="`background-image: url(${captain.imageUrl})`">
        </div>
        <div>
...
export default {
  ...
  data() {
    return {
      team: this.$createModel('Team', this.teamObject),
      captain: {},
    }
  },
  methods: {
