<template>
  <div class="flex flex-1 flex-col md:px-6 pt-10" id="content">
    ...
    <div class="px-6 md:px-0 flex justify-between items-center -order-1">
      <div>
        <h2 class="font-normal font-medium">{{ $route.params.slug }}</h2>
          ...
          <tbody class="p-2 leading-loose text-sm">
            <tr class="border-b">
              ...
              <td class="py-2 text-right font-medium text-lg">
                ...
                <span class="align-middle">{{ game.firstTeamScore }}</span>
              </td>
            </tr>
            <tr class="border-b">
              ...
              <td class="py-2 text-right font-medium text-lg">
                ...
                <span class="align-middle">{{ game.secondTeamScore }}</span>
              </td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="w-full md:w-3/5 p-8 pt-0 md:pt-10 sm:pl-1 mt-0 lg:pt-8 lg:pl-8 bg-white shadow-none">
        <div class="flex">
          <div class="md:w-1/2">
        ...
        <div class="pt-6">
          ...
          <p class="font-medium text-sm pl-2 leading-normal">{{ game.youtubeLink }}</p>
        </div>
      </div>
    </div>
  </div>
